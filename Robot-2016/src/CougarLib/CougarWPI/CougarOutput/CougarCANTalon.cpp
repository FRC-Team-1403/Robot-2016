...
CougarCANTalon::CougarCANTalon(int deviceNumber, std::string name)
	...
	m_isInverted = false;
	LiveWindow::GetInstance()->AddActuator("CougarCANTalon", m_deviceNumber, this);
	CougarDebug::endMethod("CougarCANTalon::CougarCANTalon[device number: " + std::to_string(deviceNumber) + "]");
}
/**
 * Constructor for the CougarCANTalon device.
 * @param deviceNumber The CAN ID of the Talon SRX
...
* PIDController
*/
void CougarCANTalon::PIDWrite(float output) {
 ...
 */
double CougarCANTalon::PIDGet() { return Get(); }
 ...
 * @return The current sensor value of the Talon.
 */
float CougarCANTalon::Get() const {
	int value;
 ...
 */
void CougarCANTalon::Set(float value, uint8_t syncGroup) {
 ...
 */
void CougarCANTalon::SetSetpoint(float value) { Set(value); }

/**
 * Resets the integral term and disables the controller.
 */
void CougarCANTalon::Reset() {
	ClearIaccum();
	Disable();
}
 ...
 */
void CougarCANTalon::Disable() {
	m_impl->SetModeSelect((int)CougarCANTalon::kDisabled);
 ...
 */
void CougarCANTalon::EnableControl() {
 ...
 * Enables control of the Talon, allowing the motor to move.
 */
void CougarCANTalon::Enable() { EnableControl(); }

/**
 * @return Whether the Talon is currently enabled.
 */
bool CougarCANTalon::IsControlEnabled() const { return m_controlEnabled; }

/**
 * @return Whether the Talon is currently enabled.
 */
bool CougarCANTalon::IsEnabled() const { return IsControlEnabled(); }

/**
 * @param p Proportional constant to use in PID loop.
 * @see SelectProfileSlot to choose between the two sets of gains.
 */
void CougarCANTalon::SetP(double p) {
 ...
 * @see SelectProfileSlot to choose between the two sets of gains.
 */
void CougarCANTalon::SetI(double i) {
 ...
 * @see SelectProfileSlot to choose between the two sets of gains.
 */
void CougarCANTalon::SetD(double d) {
 ...
 * @see SelectProfileSlot to choose between the two sets of gains.
 */
void CougarCANTalon::SetF(double f) {
 ...
 * @see SelectProfileSlot to choose between the two sets of gains.
 */
void CougarCANTalon::SetIzone(unsigned iz) {
 ...
 */
void CougarCANTalon::SelectProfileSlot(int slotIdx) {
 ...
 */
void CougarCANTalon::SetPID(double p, double i, double d) {
	SetP(p);
	SetI(i);
	SetD(d);
}
 ...
 */
void CougarCANTalon::SetPID(double p, double i, double d, double f) {
	SetP(p);
	SetI(i);
	SetD(d);
	SetF(f);
 ...
 */
void CougarCANTalon::SetFeedbackDevice(FeedbackDevice feedbackDevice) {
 ...
 * Select the feedback device to use in closed-loop
 */
void CougarCANTalon::SetStatusFrameRateMs(StatusFrameRate stateFrame, int periodMs) {
 ...
 * @see SelectProfileSlot to choose between the two sets of gains.
 */
double CougarCANTalon::GetP() const {
 ...
 * @see SelectProfileSlot to choose between the two sets of gains.
 */
double CougarCANTalon::GetI() const {
 ...
 */
double CougarCANTalon::GetSetpoint() const { return m_setPoint; }
 ...
 */
float CougarCANTalon::GetBusVoltage() const {
	double voltage;
 ...
 */
float CougarCANTalon::GetOutputVoltage() const {
	int throttle11;
 ...
 */
float CougarCANTalon::GetOutputCurrent() const {
	double current;
 ...
 */
float CougarCANTalon::GetTemperature() const {
	double temp;
 ...
 */
void CougarCANTalon::SetPosition(double pos) {
 ...
 * mode.
 */
double CougarCANTalon::GetPosition() const {
	int32_t position;
 ...
 */
void CougarCANTalon::SetSensorDirection(bool reverseSensor) {
 ...
 */
void CougarCANTalon::SetClosedLoopOutputDirection(bool reverseOutput) {
 ...
 */
int CougarCANTalon::GetClosedLoopError() const {
	int error;
 ...
 */
void CougarCANTalon::SetAllowableClosedLoopErr(uint32_t allowableCloseLoopError)
{
	/* grab param enum */
 ...
 */
double CougarCANTalon::GetSpeed() const {
	int32_t speed;
 ...
 */
int CougarCANTalon::GetAnalogIn() const {
	int position;
...
void CougarCANTalon::SetAnalogPosition(int newPosition) {
 ...
 */
int CougarCANTalon::GetAnalogInRaw() const { return GetAnalogIn() & 0x3FF; }
/**
 * Get the position of whatever is in the analog pin of the Talon, regardless of
 * whether it is actually being used for feedback.
 *
 ...
 */
int CougarCANTalon::GetAnalogInVel() const {
	int vel;
 ...
 * @returns The value (0 - 1023) on the analog pin of the Talon.
 */
int CougarCANTalon::GetEncPosition() const {
	int position;
...
void CougarCANTalon::SetEncPosition(int newPosition) {
 ...
 * @returns The value (0 - 1023) on the analog pin of the Talon.
 */
int CougarCANTalon::GetEncVel() const {
	int vel;
...
int CougarCANTalon::GetPulseWidthPosition() const {
	int param;
...
void CougarCANTalon::SetPulseWidthPosition(int newPosition)
{
...
int CougarCANTalon::GetPulseWidthVelocity()const
{
	int param;
...
int CougarCANTalon::GetPulseWidthRiseToFallUs()const
{
	int param;
...
int CougarCANTalon::GetPulseWidthRiseToRiseUs()const
{
	int param;
 ...
 */
CougarCANTalon::FeedbackDeviceStatus CougarCANTalon::IsSensorPresent(FeedbackDevice feedbackDevice)const
{
 ...
 */
int CougarCANTalon::GetPinStateQuadA() const {
	int retval;
 ...
 */
int CougarCANTalon::GetPinStateQuadB() const {
	int retval;
 ...
 */
int CougarCANTalon::GetPinStateQuadIdx() const {
	int retval;
 ...
 */
int CougarCANTalon::IsFwdLimitSwitchClosed() const {
	int retval;
 ...
 * This function works regardless if limit switch feature is enabled.
 */
int CougarCANTalon::IsRevLimitSwitchClosed() const {
	int retval;
 ...
 */
int CougarCANTalon::GetNumberOfQuadIdxRises() const {
	int rises;
 ...
 */
void CougarCANTalon::SetNumberOfQuadIdxRises(int rises) {
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
bool CougarCANTalon::GetForwardLimitOK() const {
	int limSwit = 0;
	int softLim = 0;
	CTR_Code status = CTR_OKAY;
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
bool CougarCANTalon::GetReverseLimitOK() const {
	int limSwit = 0;
	int softLim = 0;
	CTR_Code status = CTR_OKAY;
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
uint16_t CougarCANTalon::GetFaults() const {
	uint16_t retval = 0;
	int val;
	CTR_Code status = CTR_OKAY;
...
uint16_t CougarCANTalon::GetStickyFaults() const {
	uint16_t retval = 0;
	int val;
	CTR_Code status = CTR_OKAY;
...
void CougarCANTalon::ClearStickyFaults() {
 ...
 * V/s.
 */
void CougarCANTalon::SetVoltageRampRate(double rampRate) {
...
void CougarCANTalon::SetVoltageCompensationRampRate(double rampRate) {
 ...
 * V/s.
 */
void CougarCANTalon::SetCloseLoopRampRate(double rampRate) {
 ...
 */
uint32_t CougarCANTalon::GetFirmwareVersion() const {
	int firmwareVersion;
 ...
 */
int CougarCANTalon::GetIaccum() const {
 ...
 */
void CougarCANTalon::ClearIaccum() {
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
void CougarCANTalon::ConfigNeutralMode(NeutralMode mode) {
	CTR_Code status = CTR_OKAY;
	switch (mode) {
		default:
 ...
 * during neutral.
 */
int CougarCANTalon::GetBrakeEnableDuringNeutral() const {
	int brakeEn = 0;
 ...
 */
void CougarCANTalon::ConfigEncoderCodesPerRev(uint16_t codesPerRev) {
 ...
 */
void CougarCANTalon::ConfigPotentiometerTurns(uint16_t turns) {
	/* first save the scalar so that all getters/setter work as the user expects */
	m_numPotTurns = turns;
	/* next send the scalar to the Talon over CAN.	This is so that the Talon can report
		it to whoever needs it, like the webdash.	Don't bother checking the return,
 ...
 */
void CougarCANTalon::ConfigSoftPositionLimits(double forwardLimitPosition,
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
void CougarCANTalon::DisableSoftPositionLimits() {
 ...
 * @see ConfigLimitMode()
 */
void CougarCANTalon::ConfigLimitSwitchOverrides(bool bForwardLimitSwitchEn, bool bReverseLimitSwitchEn) {
	CTR_Code status = CTR_OKAY;
	int fwdRevEnable;
 ...
 */
void CougarCANTalon::ConfigLimitMode(LimitMode mode) {
	CTR_Code status = CTR_OKAY;
	switch (mode) {
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
void CougarCANTalon::ConfigForwardLimit(double forwardLimitPosition) {
	CTR_Code status = CTR_OKAY;
 ...
 */
void CougarCANTalon::ConfigForwardSoftLimitEnable(bool bForwardSoftLimitEn) {
	CTR_Code status = CTR_OKAY;
 ...
 */
void CougarCANTalon::ConfigReverseSoftLimitEnable(bool bReverseSoftLimitEn) {
	CTR_Code status = CTR_OKAY;
 ...
 */
void CougarCANTalon::ConfigFwdLimitSwitchNormallyOpen(bool normallyOpen) {
	CTR_Code status =
 ...
 * @param normallyOpen true for normally open.	false for normally closed.
 */
void CougarCANTalon::ConfigRevLimitSwitchNormallyOpen(bool normallyOpen) {
	CTR_Code status =
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
void CougarCANTalon::ConfigReverseLimit(double reverseLimitPosition) {
	CTR_Code status = CTR_OKAY;
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
void CougarCANTalon::ConfigMaxOutputVoltage(double voltage) {
	/* config peak throttle when in closed-loop mode in the fwd and rev direction. */
	ConfigPeakOutputVoltage(voltage, -voltage);
}
void CougarCANTalon::ConfigPeakOutputVoltage(double forwardVoltage,double reverseVoltage) {
	/* bounds checking */
...
void CougarCANTalon::ConfigNominalOutputVoltage(double forwardVoltage,double reverseVoltage) {
	/* bounds checking */
	if (forwardVoltage > 12)
		forwardVoltage = 12;
	else if (forwardVoltage < 0)
 ...
 */
void CougarCANTalon::ConfigSetParameter(uint32_t paramEnum, double value) {
	CTR_Code status;
 ...
 * be used for testing future features.
 */
bool CougarCANTalon::GetParameter(uint32_t paramEnum, double & dvalue) const {
	bool retval = true;
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
void CougarCANTalon::ConfigFaultTime(float faultTime) {
 ...
 * @see Set()
 */
void CougarCANTalon::ApplyControlMode(CANSpeedController::ControlMode mode) {
	m_controlMode = mode;
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
void CougarCANTalon::SetControlMode(CANSpeedController::ControlMode mode) {
 ...
 * TODO documentation (see CANJaguar.cpp)
 */
CANSpeedController::ControlMode CougarCANTalon::GetControlMode() const {
	return m_controlMode;
}

void CougarCANTalon::SetExpiration(float timeout) {
	m_safetyHelper->SetExpiration(timeout);
}

float CougarCANTalon::GetExpiration() const {
	return m_safetyHelper->GetExpiration();
}

bool CougarCANTalon::IsAlive() const { return m_safetyHelper->IsAlive(); }

bool CougarCANTalon::IsSafetyEnabled() const {
	return m_safetyHelper->IsSafetyEnabled();
}

void CougarCANTalon::SetSafetyEnabled(bool enabled) {
	m_safetyHelper->SetSafetyEnabled(enabled);
}

void CougarCANTalon::GetDescription(std::ostringstream& desc) const {
	desc << "CougarCANTalon ID " <<	m_deviceNumber;
}
/**
 ...
 */
double CougarCANTalon::GetNativeUnitsPerRotationScalar(FeedbackDevice devToLookup)const
{
 ...
 */
int32_t CougarCANTalon::ScaleRotationsToNativeUnits(FeedbackDevice devToLookup,double fullRotations)const
{
 ...
 */
int32_t CougarCANTalon::ScaleVelocityToNativeUnits(FeedbackDevice devToLookup,double rpm)const
{
	/* first assume we don't have config info, prep the default return */
 ...
 */
double CougarCANTalon::ScaleNativeUnitsToRotations(FeedbackDevice devToLookup,int32_t nativePos)const
{
	/* first assume we don't have config info, prep the default return */
 ...
 */
double CougarCANTalon::ScaleNativeUnitsToRpm(FeedbackDevice devToLookup, int32_t nativeVel)const
{
	/* first assume we don't have config info, prep the default return */
 ...
 */
void CougarCANTalon::EnableZeroSensorPositionOnIndex(bool enable, bool risingEdge)
{
	if (enable) {
 ...
 */
void CougarCANTalon::ChangeMotionControlFramePeriod(int periodMs)
{
 ...
 */
void CougarCANTalon::ClearMotionProfileTrajectories()
{
 ...
 */
int CougarCANTalon::GetMotionProfileTopLevelBufferCount()
{
 ...
 */
bool CougarCANTalon::PushMotionProfileTrajectory(const TrajectoryPoint & trajPt)
{
 ...
 */
bool CougarCANTalon::IsMotionProfileTopLevelBufferFull()
{
 ...
 */
void CougarCANTalon::ProcessMotionProfileBuffer()
{
 ...
 */
void CougarCANTalon::GetMotionProfileStatus(MotionProfileStatus & motionProfileStatus)
{
	uint32_t flags;
 ...
 */
void CougarCANTalon::ClearMotionProfileHasUnderrun()
{
...
*/
void CougarCANTalon::SetInverted(bool isInverted) { m_isInverted = isInverted; }
 ...
 *
 */
bool CougarCANTalon::GetInverted() const { return m_isInverted; }
...
bool CougarCANTalon::IsModePID(CANSpeedController::ControlMode mode) const {
	return mode == kCurrent || mode == kSpeed || mode == kPosition;
}

void CougarCANTalon::UpdateTable() {
	if (m_table != nullptr) {
		m_table->PutString("~TYPE~", "CANSpeedController");
		m_table->PutString("Type", "CougarCANTalon");
...
void CougarCANTalon::StartLiveWindowMode() {
	if (m_table != nullptr) {
		m_table->AddTableListener(this, true);
	}
}

void CougarCANTalon::StopLiveWindowMode() {
	if (m_table != nullptr) {
		m_table->RemoveTableListener(this);
	}
}

std::string CougarCANTalon::GetSmartDashboardType() const {
	return "CANSpeedController";
}

void CougarCANTalon::InitTable(std::shared_ptr<ITable> subTable) {
	m_table = subTable;
	UpdateTable();
}
